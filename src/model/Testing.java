...
//		PrintStream o = new PrintStream(new File("logs/Testing.txt")); 
...
//		System.out.println("Test case detail");
//		System.out.println("----------------");
//		System.out.println("- I have made 3 threads that run on Asian RM1Server and transfer operations are performed on Europe RM1Server");
